...
import type { AppData, Order, Workspace } from '../../shared/lib/types';
import { Button, Status } from '../../shared/components/ui';
import { DeliveryLocation } from './CustomerHomeShell';
import { useContent } from '../../shared/hooks/useContent';

interface CustomerLandingProps { data: AppData; order?: Order; onNavigate: (workspace: Workspace) => void; }

export function CustomerLanding({ data, order, onNavigate }: CustomerLandingProps) {
